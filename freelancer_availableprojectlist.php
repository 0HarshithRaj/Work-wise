...
<html lang="en">
	...
	<body class="homepage homepage-already">
		...
		<div id="site-content">
			...
			<main class="main-content">
				<div class="hero hero-already">
					<div class="featured-image" data-bg-image="dummy/home.jpg" style="background-image: url(&quot;dummy/home.jpg&quot;);">
						<a href="freelancer_profile.php" class="button btn2">Profile</a>
						<a href="freelancer_availableprojectlist.php" class="button btn2">Available Projects</a>
						<a href="freelancer_appliedprojectlist.php" class="button btn2">Applied Projects</a>
						<a href="freelancer_logout.php" class="button btn2">Logout (<?php echo $_SESSION['freelancer_username']; ?>)</a>
					</div>
				</div> <!-- .hero -->

				<div class="fullwidth-block" data-bg-color="#000000"> 
					<div class="container">
						<header bg-dark>
						...
						<div class="posts-list post-list-2">
