	...
	<div id="site-content">
		...
		<main class="main-content">
			<div class="hero hero-already">
				<div class="featured-image" data-bg-image="dummy/home.jpg"
					style="background-image: url(&quot;dummy/home.jpg&quot;);">
					...
					<a href="freelancer_logout.php" class="button">Logout (
						<?php echo $_SESSION['freelancer_username']; ?>)
					</a>
				</div>
			</div> <!-- .hero -->
				...
				<div class="container">
					...
					<div class="posts-list">
						...
						<div class="post" style="width:50%;">
							<div class="post-content post-content-12">
								<p><strong>Employer:</strong>
									<?php echo $row['employername']; ?> <br>
								</p>
								<p><strong>Posted On:</strong>
									<?php echo $row['submission']; ?> <br>
								</p>
								...
								<p><strong>Qualifications Required:</strong>
