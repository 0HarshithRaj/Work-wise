							...
							<div class="request-form">
								...
								<form method="post">
									...
									<div class="field">
										...
										<div>
											<input type="radio" name="registertype" value="freelancer"
												style="display:inline; width:auto; vertical-align:middle;" checked> <label
												style="display:inline;width:auto; margin-right:20px;">Freelancer</label>
											<input type="radio" name="registertype" value="employer"
												style="display:inline; width:auto; vertical-align:middle;">
									...
									<center>Don't have an Account? <a href="index.php" style="color:white;" id="already">Create Here</a>
									</center>
								</form>
							</div> <!-- .request-form -->
						</div> <!-- .col-md-5 -->
